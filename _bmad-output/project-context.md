...
|----------|----------|---------|
| 1 | **This file** | Full project context |
| 2 | [product-backlog.md](product-backlog.md) | What to work on (prioritized) |
| 3 | [docs/KNOWN_ISSUES.md](../docs/KNOWN_ISSUES.md) | Current bugs |
| 4 | [docs/INDEX.md](../docs/INDEX.md) | Documentation map |
...
### BMAD Output Documents (_bmad-output/)

| Document | Description |
|----------|-------------|
| `project-context.md` | This file - full project context |
| `product-backlog.md` | Consolidated ROADMAP + IDEAS (prioritized) |
...
|----------|-------|---------------|
| Root | 10+ | INDEX.md, ROADMAP.md, IDEAS.md, KNOWN_ISSUES.md, PRODUCT.md |
| API | 7 | WEBSOCKET.md, CHANGELOG.md, state_machine_endpoints.md |
| Architecture | 4 | DECISIONS.md, CONTAINER.md |
| Database | 4 | SCHEMA.md, QUESTDB.md, MIGRATIONS.md |
| Development | 11 | CODING_STANDARDS.md, ERROR_HANDLING.md, INDICATOR_ALGORITHM_GUIDE.md |
| Frontend | 25+ | USER_INTERFACE_GUIDE.md, STRATEGY_BUILDER_USER_GUIDE.md |
| Trading | 5 | INDICATORS.md, STRATEGIES.md, INDICATORS_TO_IMPLEMENT.md |
| Deployment | 3 | DEPLOYMENT_GUIDE.md, MONITORING.md |
| Monitoring | 1 | PROMETHEUS_METRICS_SETUP.md |
| Security | 1 | SECURITY_FIXES_AGENT_2.md |

### Archive (docs/_archive/)
- **27 files** - cleaned up historical documents
- Key preserved: MVP.md, TESTING_STANDARDS.md, deployment references
- **75+ files removed** - old agent reports, phase reports, redundant analyses
...
## 13. For AI Agents - Implementation Guide

### Before Starting Any Work

1. **Read this file** - understand project context
2. **Check product-backlog.md** - see prioritized work items
3. **Check KNOWN_ISSUES.md** - avoid duplicate work
4. **Check docs/INDEX.md** - find relevant documentation

### Priority Work Items (P0 - Critical)

| ID | Issue | Impact |
|----|-------|--------|
| CORE-01 | Fix Trading Engine | System unusable |
| CORE-02 | Fix Strategy Builder | Core feature broken |
| CORE-03 | Fix UI Components | User experience broken |

### Key Constraints to Remember

1. **No Redis** - Windows without Docker, use degraded state persistence
2. **MEXC only** - Single exchange, don't assume multi-exchange
3. **No E2E tests** - Be extra careful with integration points

### Document Updates

When completing work:
1. Update `KNOWN_ISSUES.md` if fixing bugs
2. Update `product-backlog.md` status
3. Update relevant domain docs

### File Naming Conventions

- Active docs: `docs/{category}/FILE_NAME.md`
- BMAD outputs: `_bmad-output/*.md`
- Archive: `docs/_archive/*.md` (don't modify)
