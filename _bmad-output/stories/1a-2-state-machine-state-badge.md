...
- [ ] **Task 1: Create StateBadge Component** (AC: 1, 3, 5)
  - [ ] 1.1 Create `StateBadge.tsx` with large, prominent styling
  - [ ] 1.2 Map state values to display labels
  - [ ] 1.3 Add appropriate icons for each state
  - [ ] 1.4 Size: minimum 48px font, prominent shadow

- [ ] **Task 2: Implement Color System** (AC: 2)
  - [ ] 2.1 Define color palette from UX spec
  - [ ] 2.2 Map each state to color
  - [ ] 2.3 Implement as MUI theme or styled components
  - [ ] 2.4 Include dark mode support

- [ ] **Task 3: Connect to State Data** (AC: 4)
  - [ ] 3.1 Identify source of state machine state (WebSocket/store)
  - [ ] 3.2 Subscribe to state changes
  - [ ] 3.3 Update badge on state transition
  - [ ] 3.4 Add transition animation

- [ ] **Task 4: Place on Dashboard** (AC: 3)
  - [ ] 4.1 Position badge prominently (top area)
  - [ ] 4.2 Ensure always visible without scrolling
  - [ ] 4.3 Test across viewport sizes
