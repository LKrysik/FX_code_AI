...
## PRZYKŁAD CIĄGŁEJ PĘTLI

```
Iteracja 1:
- GAP: PH1 max_drawdown = 0.0 placeholder
- Delegacja: @backend-dev napraw PH1
- Raport: naprawione, testy PASS
- GAP ANALYSIS: PH1 ✅, ale PH2 sharpe_ratio wciąż placeholder

Iteracja 2:
- Priorytet: PH2 (z GAP ANALYSIS)
- Delegacja: @backend-dev napraw PH2
- Raport: naprawione
- GAP ANALYSIS: PH1 ✅, PH2 ✅, ale B7 Session ma metrykę 5.8/10

Iteracja 3:
- Priorytet: B7 Session Manager (najniższa metryka)
- Delegacja: @backend-dev popraw B7
- ... KONTYNUUJ ...

NIGDY: "Wszystko zrobione, kończę"
ZAWSZE: "Co jeszcze nie działa? → następna iteracja"
```
